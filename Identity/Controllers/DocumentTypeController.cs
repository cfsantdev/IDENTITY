...
namespace Identity.Controllers
{
    ...
    public class DocumentTypeController 
        : IdentityController<DocumentTypeController, DocumentTypeHandler, IdentityDbContext, DocumentType, DocumentTypeDTO>,
        ...
        IDocumentTypeController
    {
        public DocumentTypeController(ILogger<DocumentTypeController> logger, IdentityDbContext context, IMapper mapper) 
        ...
        public async Task<IActionResult> Fetch()
        {
            ...
            {
                using (var e = new BaseException<DocumentTypeController, Exception>(nameof(Fetch), ex))
                {
                    e.Display();
                }
        ...
        public async Task<IActionResult> FetchById([FromBody] FetchById filtro)
        {
            ...
            {
                using (var e = new BaseException<DocumentTypeController, Exception>(nameof(FetchById), ex))
                {
                    e.Display();
                }
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(DocumentTypeDTO))]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> Create([FromBody] CreateDocumentType registry)
        {
            try
            {
            ...
            {
                using (var e = new BaseException<DocumentTypeController, Exception>(nameof(Create), ex))
                {
                    e.Display();
                }
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(DocumentTypeDTO))]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> Update([FromBody] UpdateDocumentType registry)
        {
            try
            {
            ...
            {
                using (var e = new BaseException<DocumentTypeController, Exception>(nameof(Update), ex))
                {
                    e.Display();
                }
        ...
        public async Task<IActionResult> DeleteById([FromBody] FetchById filtro)
        {
            ...
            {
                using (var e = new BaseException<DocumentTypeController, Exception>(nameof(DeleteById), ex))
                {
                    e.Display();
                }
