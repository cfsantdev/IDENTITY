...
namespace Catalog.Controllers
{
    ...
    [ApiController]
    public class ItemController : ItemHandler
    {
        public ItemController(ILogger<ItemController> logger, CatalogDbContext context) : base(logger, context)
        {
        }
